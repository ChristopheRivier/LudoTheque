...
public class Splash extends JWindow implements Runnable{
	...
	public Splash(int delay) {
		...
		SplashPicture im = new SplashPicture("ressources/logo.jpg");
		p.add(im);
		getContentPane().add(p);
		setSize( im.getImage().getWidth(null), im.getImage().getHeight(null));
	...
	class SplashPicture extends JPanel {
		...
		public SplashPicture(String file) {
			java.net.URL imageURL = Splash.class.getResource(file);
			if (imageURL != null) {
